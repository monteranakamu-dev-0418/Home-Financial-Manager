  ...
  return (
    <div className="px-4 pt-6" style={K.font}>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-5">
        {/* 支払った人 */}
        <div>
          <label className="block text-sm font-medium mb-2" style={{ color: K.labelColor ?? '#4b5563' }}>支払った人</label>
        ...
        {/* カテゴリ */}
        <div>
          <label className="block text-sm font-medium mb-2" style={{ color: K.labelColor ?? '#4b5563' }}>カテゴリ</label>
        ...
        {/* 金額 */}
        <div>
          <label className="block text-sm font-medium mb-2" style={{ color: K.labelColor ?? '#4b5563' }}>金額</label>
          <AmountInput value={amount} onChange={setAmount} required />
        </div>

        {/* 支払方法 */}
        <div>
          <label className="block text-sm font-medium mb-2" style={{ color: K.labelColor ?? '#4b5563' }}>支払方法</label>
        ...
        <div className="relative">
          <label className="block text-sm font-medium mb-2" style={{ color: K.labelColor ?? '#4b5563' }}>場所（任意）</label>
        ...
        {/* 日付 */}
        <div>
          <label className="block text-sm font-medium mb-2" style={{ color: K.labelColor ?? '#4b5563' }}>日付</label>
        ...
        {/* メモ */}
        <div>
          <label className="block text-sm font-medium mb-2" style={{ color: K.labelColor ?? '#4b5563' }}>メモ（任意）</label>
      ...
      {showDeleteModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center px-6">
          ...
          <div className="relative bg-white rounded-2xl p-6 w-full max-w-sm shadow-xl"
            style={isKawaii ? { border: '1.5px solid #fce4ec' } : {}}>
            <h2 className="text-base font-bold mb-2" style={{ color: K.title }}>支出を削除しますか？</h2>

  ...
  return (
    <div className="px-4 pt-6">
      <div className="flex items-center gap-3 mb-6">
        ...
        <h1 className="text-xl font-bold text-gray-800">支出を修正</h1>
      </div>

      <form onSubmit={handleSubmit} className="flex flex-col gap-5">
        {/* 支払った人 */}
        <div>
          <label className="block text-sm font-medium text-gray-600 mb-2">支払った人</label>
        ...
        {/* メモ */}
        <div>
          <label className="block text-sm font-medium text-gray-600 mb-2">メモ（任意）</label>
          <input
            type="text"
            value={note}
      ...
      {showDeleteModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center px-6">
          ...
          <div className="relative bg-white rounded-2xl p-6 w-full max-w-sm shadow-xl">
            <h2 className="text-base font-bold text-gray-800 mb-2">支出を削除しますか？</h2>
